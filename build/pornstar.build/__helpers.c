...
MOD_INIT_DECL( pornstar$__model );
MOD_INIT_DECL( pornstar$__utils );
static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] =
{
    ...
    { "pornstar.__model", MOD_INIT_NAME( pornstar$__model ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pornstar.__utils", MOD_INIT_NAME( pornstar$__utils ), 0, 0, NUITKA_COMPILED_MODULE },
    { NULL, NULL, 0, 0, 0 }
};
