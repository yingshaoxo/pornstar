...
MOD_INIT_DECL( pornstar$coco );
MOD_INIT_DECL( pornstar$config );
MOD_INIT_DECL( pornstar$model );
MOD_INIT_DECL( pornstar$utils );
static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] =
{
    { "pornstar", MOD_INIT_NAME( pornstar ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "pornstar.coco", MOD_INIT_NAME( pornstar$coco ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pornstar.config", MOD_INIT_NAME( pornstar$config ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pornstar.model", MOD_INIT_NAME( pornstar$model ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pornstar.utils", MOD_INIT_NAME( pornstar$utils ), 0, 0, NUITKA_COMPILED_MODULE },
    { NULL, NULL, 0, 0, 0 }
};
